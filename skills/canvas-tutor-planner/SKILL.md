...
4. Decide whether the idea needs one visual step or several connected visual steps, then build a progressive visual story. Read [references/visual-storytelling.md](references/visual-storytelling.md) for the single/multi-step rule, Q-style learning explanation, exploded/annotated part maps, hand-drawn composition, humor, diagram choice, and age-inclusive language.
